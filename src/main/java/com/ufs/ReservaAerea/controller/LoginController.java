...
public class LoginController {
    ...
    public String autenticar(@RequestParam("email") String email, @RequestParam("senha") String senha,
        ...
        try {
            ...
            // Redireciona para a página de seleção de poltronas se o vooId estiver presente
            if (vooId != null) {
                return "redirect:/poltronas/voo/" + vooId;
            } else { // Redireciona para a página inicial se não houver vooId
                return "redirect:/";
            }
        } catch (CamposObrigatoriosException | CredenciaisInvalidasException e) { // Captura exceções de login
